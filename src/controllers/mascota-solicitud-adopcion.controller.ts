...
export class MascotaSolicitudAdopcionController {
  ...
  async find(
    ...
    return this.mascotaRepository.solicitudesDeAdpcion(id).find(filter);
  }
  ...
  async create(
    ...
    return this.mascotaRepository.solicitudesDeAdpcion(id).create(solicitudAdopcion);
  }
  ...
  async patch(
    ...
    return this.mascotaRepository.solicitudesDeAdpcion(id).patch(solicitudAdopcion, where);
  }
  ...
  async delete(
    ...
    return this.mascotaRepository.solicitudesDeAdpcion(id).delete(where);
  }
}
